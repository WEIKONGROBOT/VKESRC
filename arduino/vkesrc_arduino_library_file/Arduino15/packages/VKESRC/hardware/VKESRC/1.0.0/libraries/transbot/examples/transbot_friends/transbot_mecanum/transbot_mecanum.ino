...
void controlMecanum()
{
  ...
  Serial.print(" W : "); Serial.println(goal_angular_velocity);
#endif
  Serial.print(" wheel_value[0] : "); Serial.println((int64_t)wheel_value[0]);
...
void controlMecanum()
{
  ...
  int16_t wheel_value[MECANUMWHEEL_NUM] = {0, 0, 0, 0};
  double wheel_angular_velocity[MECANUMWHEEL_NUM] = {0.0, 0.0, 0.0, 0.0};
  uint8_t wheel_value_data_byte[MECANUMWHEEL_NUM][2] = {0,0,0,0,0,0,0,0 };
  int8_t velocity_direction_flag[MECANUMWHEEL_NUM]= {VELOCITY_DIRECTION_LEFT_FRONT_FLAG,VELOCITY_DIRECTION_RIGHT_FRONT_FLAG,VELOCITY_DIRECTION_LEFT_REAR_FLAG,VELOCITY_DIRECTION_RIGHT_REAR_FLAG};
